...
Watches a key path and calls the handler function when it is changed. You may use [minimatch][external_package_minimatch] to watch dynamic key paths, like `"foo.*"`.
